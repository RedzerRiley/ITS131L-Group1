...
CREATE TABLE EMPLOYEE (
    ...
    EMP_CONTACT INT(10) CHECK (EMP_CONTACT > 0),
...
CREATE TABLE DEPENDENTS (
    ...
    DEP_DOB DATE,
    DEP_CONTACT INT(10) CHECK (DEP_CONTACT > 0),
...
CREATE TABLE CUSTOMER (
    ...
    CUSTOMER_CONTACT INT(10) CHECK (CUSTOMER_CONTACT > 0),
